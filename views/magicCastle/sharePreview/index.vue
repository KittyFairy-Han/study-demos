...
import onePrize from '../../components/prizesResult/one.vue'
import fivePrizes from '../../components/prizesResult/five.vue'
import { mapState } from 'vuex'
import { watchImgLoad } from 'components/util/poster'

export default {
	components: { onePrize, fivePrizes },
	props: {
		curPrizesResult: {
			type: String,
			default: '',
